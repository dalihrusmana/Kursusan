...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <a href="" class="btn btn-primary mb-3 tombolTambahData" data-toggle="modal" data-target="#newSubMenuModal">Tambahkan Submenu Baru</a>
                    ...
                    <?php foreach ($subMenu as $sm) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url() ?>menu/hapussubmenu/<?= $sm['id']; ?>" class="badge badge-danger" onclick="return confirm('Apakah yakin ingin menghapus Data Sub Menu?');">Delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
